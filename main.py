...
if __name__ == '__main__':
    ...
    download_song()
    if boost.lower() == "y":
        boost_lvl = input("How much boost?(1/2/3)")
        if boost_lvl == "1":
            accentuate_db = 10
            print("\n"+ Fore.GREEN + "Light boost!" + Style.RESET_ALL + "\n")
        if boost_lvl == "2":
            accentuate_db = 15
            print("\n"+ Fore.YELLOW + "Medium boost!" + Style.RESET_ALL + "\n")
        if boost_lvl == "3":
            accentuate_db = 25
            print("\n"+ Fore.RED + "INSANE BOOST!" + Style.RESET_ALL + "\n")
